        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          >
            <div className="flex items-center justify-center md:justify-start space-x-2 mb-4">
              ...
              <span className="text-xl font-bold gradient-text">Harshala Rani</span>
            </div>
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className={`w-10 h-10 glass-effect rounded-full flex items-center justify-center text-gray-400 transition-all duration-300 ${social.color}`}
                  >
